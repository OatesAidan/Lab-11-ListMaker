...
// by Aidan Oates
    ...
    public static void addToArrList(Scanner in, ArrayList arrList) {
        String itemToAdd = SafeInput.getNonZeroLenString(in, "What do you want to add to the array list");
        arrList.add(itemToAdd);
    }
    public static void deleteFromArrList(Scanner in, ArrayList arrList) {
        int itemToDelete = SafeInput.getRangedInt(in, "What do you want to delete", 1, arrList.size());
